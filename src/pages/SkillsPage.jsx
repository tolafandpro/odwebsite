        ...
        <Main>
          ...
          <Description>
            ...
            <ul>
              ...
              <li>Wordpress, Shopify, Saas.</li>
            </ul>
          </Description>
          <Description>
            <strong>Tools</strong>
            <ul>
              <li>VScode, Mui, Tailwind</li>
            </ul>
          </Description>
        </Main>
        <Main>
          ...
          <Description>
            I value business or brand for which i'm creating, however i enjoy
            bringing new ideas to life.
          </Description>
          <Description>
            <strong>Skills</strong>
            <p>Java, NodeJS, MongoDB, SQL, Firebase. etc.</p>
          </Description>
          <Description>
            <strong>Tools</strong>
            <p>VScode, InteliJ, Github, Codepen etc.</p>
          </Description>
        </Main>
